function TarjetaForm({ tarjeta, onSave, onClose }) {
  ...
  return /* @__PURE__ */ React.createElement(Modal, { title: tarjeta ? "Editar tarjeta" : "Nueva tarjeta", onClose }, /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Alias"), /* @__PURE__ */ React.createElement("input", { value: form.alias, onChange: (e) => actualizar("alias", e.target.value), placeholder: "Ej. BBVA Azul" })), /* @__PURE__ */ React.createElement("div", { className: "form-row" }, /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Banco"), /* @__PURE__ */ React.createElement("select", { value: form.banco, onChange: (e) => actualizar("banco", e.target.value) }, BANCOS_MEXICO.map((b) => /* @__PURE__ */ React.createElement("option", { key: b, value: b }, b)))), /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Color"), /* @__PURE__ */ React.createElement("input", { type: "color", value: form.color, onChange: (e) => actualizar("color", e.target.value), style: { height: "38px" } }))), form.banco === "Otro" && /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "\xBFCu\xE1l banco?"), /* @__PURE__ */ React.createElement("input", { value: form.bancoOtro, onChange: (e) => actualizar("bancoOtro", e.target.value), placeholder: "Nombre del banco" })), /* @__PURE__ */ React.createElement("div", { className: "form-row" }, /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "L\xEDmite de cr\xE9dito"), /* @__PURE__ */ React.createElement("input", { type: "number", value: form.limite, onChange: (e) => actualizar("limite", e.target.value), placeholder: "20000" })), /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Cr\xE9dito disponible"), /* @__PURE__ */ React.createElement("input", { type: "number", value: form.disponible, onChange: (e) => actualizar("disponible", e.target.value), placeholder: "5000" }))), form.limite && form.disponible !== "" && /* @__PURE__ */ React.createElement("p", { style: { fontSize: "12px", color: "var(--text-dim)", marginTop: "-8px", marginBottom: "14px" } }, "Eso significa que tienes usado: ", /* @__PURE__ */ React.createElement("strong", { style: { color: "var(--text)" } }, FinanceUtils.formatoMoneda(saldoCalculado))), /* @__PURE__ */ React.createElement("div", { className: "form-row" }, /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Tasa anual (%)"), /* @__PURE__ */ React.createElement("input", { type: "number", value: form.tasaAnual, onChange: (e) => actualizar("tasaAnual", e.target.value), placeholder: "58.3" })), /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Pago m\xEDnimo"), /* @__PURE__ */ React.createElement("input", { type: "number", value: form.pagoMinimo, onChange: (e) => actualizar("pagoMinimo", e.target.value), placeholder: "750" }))), /* @__PURE__ */ React.createElement("div", { className: "form-row" }, /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "D\xEDa de corte (1-31)"), /* @__PURE__ */ React.createElement("input", { type: "number", min: "1", max: "31", value: form.diaCorte, onChange: (e) => actualizar("diaCorte", e.target.value), placeholder: "10" })), /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "D\xEDa l\xEDmite de pago (1-31)"), /* @__PURE__ */ React.createElement("input", { type: "number", min: "1", max: "31", value: form.diaPago, onChange: (e) => actualizar("diaPago", e.target.value), placeholder: "30" }))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "8px", marginTop: "20px" } }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: guardar, style: { flex: 1 } }, "Guardar"), /* @__PURE__ */ React.createElement("button", { className: "btn btn-secondary", onClick: onClose }, "Cancelar")));
}
