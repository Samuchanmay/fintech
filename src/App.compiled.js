...
function App() {
  ...
  async function confirmarImportacionPDF(tarjetaId, resultado) {
    ...
    if (tarjetaActual && resultado.resumen) {
      ...
      const tarjetaActualizada = {
        ...
        diaCorte: r.fechaCorte ? (/* @__PURE__ */ new Date(r.fechaCorte + "T00:00:00")).getDate() : tarjetaActual.diaCorte,
        diaPago: r.fechaLimitePago ? (/* @__PURE__ */ new Date(r.fechaLimitePago + "T00:00:00")).getDate() : tarjetaActual.diaPago
      };
  ...
  switch (vistaActiva) {
    case "dashboard":
      ...
      break;
    case "tarjetas":
      vista = /* @__PURE__ */ React.createElement(
        TarjetasModule,
        {
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "sidebar-account" }, /* @__PURE__ */ React.createElement("button", { className: "nav-item", style: { color: "var(--signal)" }, onClick: () => setImportarPDFAbierto(true), disabled: datos.tarjetas.length === 0 }, "\u{1F4C4} Importar PDF"), guardando && /* @__PURE__ */ React.createElement("div", { style: { fontSize: "11px", color: "var(--text-dim)", padding: "6px 12px" } }, "Guardando\u2026"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "11px", color: "var(--text-dim)", padding: "6px 12px", wordBreak: "break-all" } }, sesion.user.email), /* @__PURE__ */ React.createElement("button", { className: "nav-item", style: { color: "var(--danger)" }, onClick: manejarCerrarSesion }, "\u{1F6AA} Cerrar sesi\xF3n"))), /* @__PURE__ */ React.createElement("main", { className: "main-content" }, vista), importarPDFAbierto && /* @__PURE__ */ React.createElement(
    ImportarPDFModal,
    {
      tarjetas: datos.tarjetas,
