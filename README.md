...
## Importar tu estado de cuenta en PDF

Desde la pantalla de Tarjetas o el botón "📄 Importar PDF" en la barra lateral, puedes subir el PDF de tu estado de cuenta. La app intenta detectar automáticamente: saldo total, límite de crédito, fechas de corte y pago, tasa de interés, tus compras a meses sin intereses, y tus gastos del periodo — y te deja revisar y corregir todo antes de guardar nada.

**Limitación honesta:** el detector de patrones está calibrado específicamente para el formato de Banamex/Citibanamex. Con otros bancos puede no detectar nada — en ese caso, simplemente captura tus datos a mano en el formulario de cada tarjeta, como siempre.

## Cómo se captura una tarjeta

En vez de capturar "cuánto debes", capturas **cuánto crédito te queda disponible** (el número que tu banco te muestra como "crédito disponible"). La app calcula sola cuánto has usado (límite menos disponible). Esto evita errores comunes de cálculo manual.
